...
namespace Infrastructure.Repositories.Migrations
{
    ...
    [Migration("20240527155554_RemoveSomeStuff")]
    partial class RemoveSomeStuff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Entities.EdgeBoxModel", b =>
                {
                    ...
                    b.Property<int>("MaxNumberOfRunningAi")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Incident", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.SupervisorAssignment", "Assignment")
                        .WithMany("Incidents")
